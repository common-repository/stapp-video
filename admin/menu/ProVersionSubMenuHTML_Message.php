...
<div class="config_block" >
    <div class="config_border">
        <div class="config_border_headline">
            <?php esc_html_e( "STApp Video Pro Features are enabled!", 'stapp_video' ); ?>
        </div>
        ...
        <div class="proversion_main_container">
            <div class="proversion_container">
                ...
                <div class="headline_container">
                    <h2 class="headline_try_pro_text"><?php esc_html_e( "Thank you, all Pro Features are enabled", 'stapp_video' ); ?></h2>
                </div>
